<?php 
    ...
    try {
        ...
        $mail->Username   = 'belogicus@gmail.com';                     // SMTP username
        $mail->Password   = 'KingKong778';                               // SMTP password
