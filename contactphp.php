<?php 
    ...
    try {
        ...
        $mail->addAddress('belogicus@gmail.com', 'BeLogicus');     // Add a recipient
        ...
        $mail->AltBody = $fname." ".$lname." has sent a message from www.belogicus.org. The message is: ".$message;

        $mail->send();
        $messagecon = 'Message sent successfully';
    } catch(Exception $e) {
        $messagecon = 'Message could not send';
    }
?>